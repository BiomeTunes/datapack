...
# Enable intro track
execute unless score @s biome matches 12 run tellraw @s[tag=receiveBiomeMsg, scores={soundtrackState=1}] ["",{"text":"You entered a snowy biome","color":"gray","italic":true}]
