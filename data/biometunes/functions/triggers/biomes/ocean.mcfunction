...
# Enable intro track
execute unless score @s biome matches 0 run tellraw @s[tag=receiveBiomeMsg, scores={soundtrackState=1}] ["",{"text":"You entered an ocean biome","color":"gray","italic":true}]
