...
# Enable main track 
execute as @s[scores={biome=1, soundtrackState=1..}] run scoreboard players set @s soundtrackState 2
# Enable intro track
...
tellraw @s[tag=receiveBiomeMsg, scores={soundtrackState=1}] ["",{"text":"You entered a plains biome","color":"gray","italic":true}]
