...
# Enable intro track
execute unless score @s biome matches 1 run tellraw @s[tag=receiveBiomeMsg, scores={soundtrackState=1}] ["",{"text":"You entered a plains biome","color":"gray","italic":true}]
