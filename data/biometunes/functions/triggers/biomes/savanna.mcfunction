...
# Enable intro track
execute unless score @s biome matches 35 run tellraw @s[tag=receiveBiomeMsg, scores={soundtrackState=1}] ["",{"text":"You entered a savanna biome","color":"gray","italic":true}]
