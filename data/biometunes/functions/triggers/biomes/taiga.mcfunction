...
# Enable intro track
execute unless score @s biome matches 5 run tellraw @s[tag=receiveBiomeMsg, scores={soundtrackState=1}] ["",{"text":"You entered a taiga biome","color":"gray","italic":true}]
