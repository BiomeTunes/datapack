...
# Enable intro track
execute unless score @s biome matches 14 run tellraw @s[tag=receiveBiomeMsg, scores={soundtrackState=1}] ["",{"text":"You entered a mushroom fields biome","color":"gray","italic":true}]

# Set biome variable to plains
scoreboard players set @s biome 14
scoreboard players set @s biomeAmbient 14

# Set soundtrack time
scoreboard players set @s musicLength 193360
