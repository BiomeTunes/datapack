...
execute as @a at @s unless entity @e[type=minecraft:ender_dragon, distance=..200] unless entity @e[type=minecraft:wither, distance=..200] unless entity @e[type=minecraft:elder_guardian, distance=..200] run scoreboard players set @s bossfight 0
...
execute at @s if entity @e[type=minecraft:wither, limit=1, sort=nearest, distance=..200] run function biometunes:triggers/bosses/wither
#
